...
export const Route = createFileRoute("/_authenticated/reading/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sua biblioteca pessoal: livros para ler, em leitura, concluídos e favoritos.",
      },
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          <span className="text-[10px] font-heading font-black text-discipline tabular-nums">
            {pct}%
          </span>
        </div>
        <div className="mt-1.5 flex items-center gap-2 flex-wrap">
          ...
          {b.rating ? (
            <span className="text-[10px] text-warning">{"★".repeat(b.rating)}</span>
          ) : null}
      ...
      <header className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Link
            ...
            className="size-9 grid place-items-center rounded-full bg-discipline text-black"
          >
      ...
      {list.length === 0 ? (
        <div className="border border-dashed border-border rounded-2xl p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Nenhum livro aqui ainda. Comece sua biblioteca.
          </p>
          <Link
            to="/reading/new"
