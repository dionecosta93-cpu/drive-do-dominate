...
import { trackCreated } from "@/lib/track";
...
export const Route = createFileRoute("/_authenticated/tasks/new")({
  ...
  head: () => ({
    meta: [
      { title: "Nova tarefa — Disciplina Absoluta" },
      { name: "description", content: "Cadastre uma missão com todos os detalhes." },
    ],
  }),
});
