 ...
 *
 * - NÃO é um painel; apenas envia eventos para um Analytics central externo.
 * - Desligada por padrão: só envia se `VITE_ANALYTICS_API_URL` e `VITE_APP_ID`
 *   estiverem configurados (ver `.env.example`).
